...
public class DriverHelpers {
   ...
   //Generic Driver Methods
    ...
    public static void launchSiteURL (String inURL, String Device){


        if (Device != "") {

            driver = MobileEmulationHelpers.SetMobileEmulation(inURL, Device);
        }
   ...
   //Deprecated but useful methods
    ...
    public static WebElement clickOnElementXPATH(String xpath) {
